**Hej jestem [Ksero](https://uwudziewczynka.duckdns.org) a to jest repo mojego uniwersum.** Chcesz poczytać o moim świecie lub jesteś graczem i chcesz coś poczytać zerknij do środka. Postępuj pokolei z tym tutorialem aby go zainstalować u siebie na komputerze. Pamiętaj że moge dorzucać zmiany wiec aby być na bieżąco używaj skryptu AKTUALIZUJ.bat
## Tutorial instalacji
### 0. **Pojęcia**
